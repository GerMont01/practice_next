...
export default function Home() {
    return (
      <div className="flex flex-col items-center h-full bg-gray-100">
        <Banner/>
        <Featured/>
        <div className="flex flex-col items-center w-full py-20 text-center">
            <h2 className="mb-10 text-3xl font-bold text-gray-800">Why Shop With Us?</h2>
            <div className="grid w-3/5 grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
              ...
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-12 h-12 mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-700">30-Day Guarantee</h3>
